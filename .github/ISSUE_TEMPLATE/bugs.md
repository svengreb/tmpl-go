...
- **Ensure the bug is reproducible and has not already been fixed** — use the [latest version](https://github.com/svengreb/tmpl-go/releases/latest) and [`main`](https://github.com/svengreb/tmpl-go/tree/main) branch.
...
- What is the version of tmpl-go you are using?
